...
> 1.1 规划（编号位移：d02 原文称 022/023，因 022 编号被 release-gate 占用，实际编号为 023/024）：
> - **023 cli-contract-hardening**（契约层硬化，2026-04-22 立骨架）：`prism --json` 统一 outer schema · `prism manifest --json` 元数据接口 · CLI 版本联动 SDK `VERSION`
