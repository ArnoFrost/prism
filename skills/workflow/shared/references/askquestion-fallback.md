...
|---|---|---|---|---|
| **intake** | 路由门（§4.1） | Phase 2 路由决策（new/append/ask_user） | **低频启动**（每次 intake 1 次） | 候选清单庄重、默认新建；append 须显式目标，见 [intake-routing-spec.md](../../intake/references/intake-routing-spec.md) |
