...
```bash
uv run python skills/workflow/workflow-intake/scripts/index_update.py <ws> reactivate <num> <name> [--desc]
```
...
```
workflow/workflow-archive/SKILL.md   # §3 archive + §8 reactivate
workflow/shared/scripts/archive.py
workflow/shared/scripts/reactivate.py
workflow/workflow-intake/scripts/index_update.py
```
