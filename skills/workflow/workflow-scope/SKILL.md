...
| **写什么** | `scope.md`（原地）、`focus.md`（rewrite）、`decision.index.md` / `task.index.md` 按需 |
...
「只改 focus / 只改 task.index」必须拒绝：先 scope，再 focus-derive 刷新。
...
| `structures/task.index.md` | 按需 | 仅当 scope 深化出 task |
