...
> **路由分叉（cite，不复制）**：review/review-lite cohesion 可落盘 ≠ intake 默认 new。Protocol 层分流句见 `AGENTS.md`；路由矩阵 SSOT 仍见 [topic-sniff-spec.md §0.1](../../shared/topic-sniff-spec.md)。
...
Fixture：`FR-other-scope-upgrade` — 维护于 review-lite FR fixture SSOT。
