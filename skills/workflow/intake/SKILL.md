...
按路由结果读取 [intake-templates.md](references/intake-templates.md) 生成/补全骨架。新建专项创建全部模板文件；内聚到已有专项只更新专项根目录文件（补骨架、追加 `intake.md`、补 `scope.md` 未决问题、刷新 `README.md`），不得创建额外子目录。
