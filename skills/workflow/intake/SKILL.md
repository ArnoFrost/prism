...
| **读取工件** | sniff 输出（workspace / topic_affinity / format）、intake-templates.md、intake-fallback.md |
| **写入工件** | intake.md（新建/追加）、README.md、scope.md（草稿骨架）、plan.md（占位）、review.index.md（占位）、index.md（专项引用） |
