...
2. 确认当前路径配置：`sdk_path`, `skills_path`, `vault_path`, `workspace_subdir`
3. 确认注册项目列表

## 场景一：Vault 路径迁移

当用户需要将 Workspace 实例迁移到新 vault 路径时。
