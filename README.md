...
[![Stage](https://img.shields.io/badge/stage-v3.0--beta-orange)](docs/prism-3.0.md)
...
**当前阶段**：`v3.0.0-beta`（dogfood 验证期）— `focus` 单入口、按需 `task` 递归分解、README grandfather 兼容；内置 **workflow** 是一套可选的认知熵治理工作流。  
