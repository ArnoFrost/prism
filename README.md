...
[![Stage](https://img.shields.io/badge/stage-4.0.0-canary.4-release-blue)](CHANGELOG.md)
...
**当前发行**：4.0.0-canary.4。当前使用 **experimental natural dogfood** Distribution Profile，只分发 `/prism`、`/prism-review`、`/prism-plan` 三个入口。3.x 实现已从本分支剔除，终态见 git tag `legacy-3x-final`；旧 topic 在本分支只读。
...
| 项 | 当前口径 |
|----|----------|
| Release | [`4.0.0-canary.4`](VERSION) |
| Package version | `4.0.0.dev4`（PEP 440） |
| Python | 3.11+ |
| License | [MIT](LICENSE) |
| 当前命令面 | `prism --help` |
