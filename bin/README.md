...
| `prism` | workflow verb CLI 统一入口（sniff / validate / archive / migrate / sync / finalize / tidy / status / digest / manifest） | 所有 workflow skill | ✅ 可用 |
